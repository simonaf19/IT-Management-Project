...
**Objective**  
The goal of this testing is to evaluate how easily a user can navigate the platform and understand housing safety information such as certifications, inspections, and complaints.
...
* Task 1: 40 seconds – completed easily

* Task 2: 2 minutes – some confusion

* Task 3: 1 minute – completed without issues

* Task 4: 1.5 minutes – completed with some hesitation
